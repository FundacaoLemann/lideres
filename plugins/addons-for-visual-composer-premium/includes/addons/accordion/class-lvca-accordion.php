...
class LVCA_Accordion {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $output = '<div class="lvca-accordion lvca-' . $style
        ...
        return apply_filters('lvca_accordion_output', $output, $content, $settings);
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        return apply_filters('lvca_accordion_item_output', $output, $content, $settings);
