...
class LVCA_Tabs {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $output = '<div id="lvca-tabs-' . $uniqueid
            . '" class="lvca-tabs ' . $vertical_class . ' lvca-' . esc_attr($style)
            . '" data-mobile-width="' . intval($mobile_width) . '">';
        ...
        $highlight_styles = array('style4', 'style6', 'style7', 'style8');
        ...
        return apply_filters('lvca_tabs_output', $output, $content, $settings);
    }
