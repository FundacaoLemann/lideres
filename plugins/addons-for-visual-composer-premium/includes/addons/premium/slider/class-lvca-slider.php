...
class LVCA_Slider {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $output = '<div ' . esc_html($id)
            . ' class="lvca-slider lvca-container ' . esc_attr($settings['class'])
            . '" data-settings=\'' . wp_json_encode($settings)
            . '\'>';

        $output .= '<div class="lvca-flexslider">';
        ...
        return apply_filters('lvca_slider_output', $output, $content, $settings);
    }
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        return apply_filters('lvca_slide_output', $output, $content, $settings);
    }
