...
class LVCA_Posts_Block {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $settings['block_id'] = 'block-' . get_the_ID() . '-' . self::$block_counter;

        $settings['block_class'] = !empty($settings['block_class']) ? sanitize_title($settings['block_class']) : $settings['block_id'];
        ...
        return apply_filters('lvca_posts_block_output', $output, $content, $settings);
    }
        ...
        if (function_exists("vc_map")) {
            ...
            $display_params = array(
                ...
                array(
                    ...
                    'dependency' => array(
                        'element' => 'block_type',
                        'value' => array('block_1', 'block_2', 'block_3', 'block_6', 'block_8', 'block_9', 'block_11', 'block_13'),
                    ),
                ),
