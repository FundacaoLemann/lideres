...
class LVCA_Countdown {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        if (!empty($end_date)) :
            ...
            $output .= '<div class="lvca-countdown-wrap lvca-align' . $align . '">';

            $output .= '<div class="lvca-countdown-label">' . $label . '</div>';

            $output .= '<div class="lvca-countdown" data-end-date="' . $end_date . '"></div>';

            $output .= '</div>';

        endif;

        return apply_filters('lvca_countdown_output', $output, $content, $settings);
    }
