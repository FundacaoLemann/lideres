...
class LVCA_Portfolio {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $settings['block_id'] = 'grid-' . get_the_ID() . '-' . self::$grid_counter;

        $settings['block_class'] = !empty($settings['grid_class']) ? sanitize_title($settings['grid_class']) : $settings['block_id'];
        ...
        return apply_filters('lvca_posts_grid_output', $output, $content, $settings);
    }
