...
class LVCA_Services {
    ...
    public function shortcode_func($atts, $content = null, $tag) {
        ...
        $output = '<div id="lvca-services' . uniqid()
            . '" data-settings=\'' . htmlspecialchars(json_encode($settings))
            . '\' class="lvca-services lvca-' . $settings['style'] . ' lvca-grid-container ' . lvca_get_grid_classes($settings)
            . '">';
        ...
        return apply_filters('lvca_services_output', $output, $content, $settings);
    }
    ...
    public function child_shortcode_func($atts, $content = null, $tag) {
        ...
        if ($icon_type == 'icon_image') :
            ...
            $output .= wp_get_attachment_image($icon_image, 'full', false, array('class' => 'lvca-image full'));
        ...
        return apply_filters('lvca_service_item_output', $output, $content, $settings);
