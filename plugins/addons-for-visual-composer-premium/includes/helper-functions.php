...
function lvca_get_grid_classes($settings, $columns_field = 'per_line') {
    ...
    return apply_filters('lvca_grid_classes', $grid_classes, $settings, $columns_field);
}
...
function lvca_get_option($option_name, $default = null) {
    ...
    return apply_filters('lvca_get_option', $option_value, $option_name, $default);
}
...
function lvca_get_taxonomy_terms_filter($taxonomies, $chosen_terms = array()) {
    ...
    return apply_filters('lvca_taxonomy_terms_filter', $output, $taxonomies, $chosen_terms);
}
...
function lvca_get_animation_options() {
    ...
    if (lvca_fs()->can_use_premium_code__premium_only()) {
        return apply_filters('lvca_animation_options',  array(
            ...
            __('Bounce', 'livemesh-vc-addons') => 'bounce',
            __('Flash', 'livemesh-vc-addons') => 'flash',
            __('Pulse', 'livemesh-vc-addons') => 'pulse',
            __('Swing', 'livemesh-vc-addons') => 'swing',
            __('Shake', 'livemesh-vc-addons') => 'shake',
            __('Tada', 'livemesh-vc-addons') => 'tada',
            __('Wobble', 'livemesh-vc-addons') => 'wobble',
            __('Jello', 'livemesh-vc-addons') => 'jello',
            __('Rubber Band', 'livemesh-vc-addons') => 'rubberBand',
            __('Bounce In', 'livemesh-vc-addons') => 'bounceIn',
            __('Bounce In Left', 'livemesh-vc-addons') => 'bounceInLeft',
            __('Bounce In Right', 'livemesh-vc-addons') => 'bounceInRight',
            __('Bounce In Down', 'livemesh-vc-addons') => 'bounceInDown',
            __('Bounce In Up', 'livemesh-vc-addons') => 'bounceInUp',
            __('Fade In', 'livemesh-vc-addons') => 'fadeIn',
            __('Fade In Left', 'livemesh-vc-addons') => 'fadeInLeft',
            __('Fade In Left Big', 'livemesh-vc-addons') => 'fadeInLeftBig',
            __('Fade In Right', 'livemesh-vc-addons') => 'fadeInRight',
            __('Fade In Right Big', 'livemesh-vc-addons') => 'fadeInRightBig',
            __('Fade In Up', 'livemesh-vc-addons') => 'fadeInUp',
            __('Fade In Up Big', 'livemesh-vc-addons') => 'fadeInUpBig',
            __('Fade In Down', 'livemesh-vc-addons') => 'fadeInDown',
            __('Fade In Down Big', 'livemesh-vc-addons') => 'fadeInDownBig',
            __('Flip', 'livemesh-vc-addons') => 'flip',
            __('Flip In X', 'livemesh-vc-addons') => 'flipInX',
            __('Flip In Y', 'livemesh-vc-addons') => 'flipInY',
            __('Light Speed In', 'livemesh-vc-addons') => 'lightSpeedIn',
            __('Rotate In', 'livemesh-vc-addons') => 'rotateIn',
            __('Rotate In Up Left', 'livemesh-vc-addons') => 'rotateInUpLeft',
            __('Rotate In Up Right', 'livemesh-vc-addons') => 'rotateInUpRight',
            __('Rotate In Down Left', 'livemesh-vc-addons') => 'rotateInDownLeft',
            __('Rotate In Down Right', 'livemesh-vc-addons') => 'rotateInDownRight',
            __('Slide In Left', 'livemesh-vc-addons') => 'slideInLeft',
            __('Slide In Right', 'livemesh-vc-addons') => 'slideInRight',
            __('Slide In Down', 'livemesh-vc-addons') => 'slideInDown',
            __('Slide In Up', 'livemesh-vc-addons') => 'slideInUp',
            __('Zoom In', 'livemesh-vc-addons') => 'zoomIn',
            __('Zoom In Left', 'livemesh-vc-addons') => 'zoomInLeft',
            __('Zoom In Right', 'livemesh-vc-addons') => 'zoomInRight',
            __('Zoom In Down', 'livemesh-vc-addons') => 'zoomInDown',
            __('Zoom In Up', 'livemesh-vc-addons') => 'zoomInUp',
            __('Roll In', 'livemesh-vc-addons') => 'rollIn'
        ));
    }
    else {
        return apply_filters('lvca_animation_options', array(
