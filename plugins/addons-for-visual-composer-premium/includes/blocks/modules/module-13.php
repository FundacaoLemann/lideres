...
class LVCA_Module_13 extends LVCA_Module {
    ...
    function render() {
        ...
        <article
                class="lvca-module-13 <?php echo $module->get_module_classes(); ?> <?php echo join(' ', get_post_class('', $module->post_ID)); ?>">
        ...
        return apply_filters('lvca_block_module_13', $output, $module);
    }
}