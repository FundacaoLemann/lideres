...
abstract class LVCA_Block_Header {
    ...
    public function get_block_header() {
        ...
        $output .= apply_filters('lvca_' . $this->get_setting('header_template') . '_title', $this->get_block_title(), $this);

        $output .= apply_filters('lvca_' . $this->get_setting('header_template') . '_taxonomy_filter_output', $this->get_block_taxonomy_filter(), $this);

        $output .= '</div>';

        return apply_filters('lvca_block_header_output', $output, $this);
    }
