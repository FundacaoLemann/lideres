...
function lvca_load_posts_block_callback() {
    ...
    echo json_encode(apply_filters('lvca_block_ajax_output_array', $outputArray, $ajax_parameters));
...
function lvca_parse_block_query($params) {
    ...
    return apply_filters('lvca_block_parsed_query_args', $q, $params);
}
...
function lvca_parse_block_settings($settings) {
    ...
    return apply_filters('lvca_block_parsed_settings', $s, $settings);
}