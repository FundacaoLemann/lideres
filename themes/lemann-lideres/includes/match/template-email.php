    ...
    <div id="container" style="display: block; margin: auto; max-width: 700px; width: 100%;">
        ...
        <footer>
            <p style="padding: 20px 0 40px;">
                <a href="https://lideres.fundacaolemann.org.br/vagas/" style="background: #083050; border-radius: 5px; color: white; padding: 10px 20px; text-decoration: none;">Confira outras oportunidades</a>
            </p>
        </footer>
    </div>
</body>